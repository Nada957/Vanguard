...
export const AdminPortal: React.FC<AdminPortalProps> = ({ isPremium, currentSheetId, currentThemeId, onClose }) => {
      ...
      <div className="max-w-md w-full bg-[#111] border-2 border-[#00ffff]/30 rounded-[2.5rem] p-10 shadow-[0_0_50px_rgba(0,255,255,0.1)] relative">
        ...
        <div className="text-center space-y-8 max-h-[85vh] overflow-y-auto pr-4 scrollbar-hide">
          ...
          {isPremium ? (
            ...
            <div className="bg-black/40 border border-white/5 rounded-2xl p-6 text-left space-y-4">
               <h3 className="text-[9px] uppercase tracking-[0.3em] font-black text-[#00ffff]/60 border-b border-white/5 pb-2">Premium Feature Locked</h3>
               <p className="text-[10px] text-white/50 leading-relaxed">
                 Apply the license key in your Google Sheet config to unlock theme previews and share links.
               </p>
            </div>
          )}
